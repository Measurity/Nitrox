...
public class RigidbodyDrawer : IDrawer<Rigidbody>
{
    ...
    public RigidbodyDrawer(DimensionDrawer dimensionDrawer)
    {
        this.dimensionDrawer = dimensionDrawer;
    }

    public Rigidbody Draw(Rigidbody rb)
    {
        ...
        using (new GUILayout.HorizontalScope())
        {
            ...
            NitroxGUILayout.Separator();
            dimensionDrawer.Draw(rb.velocity, VALUE_MAX_WIDTH);
        }
        ...
        using (new GUILayout.HorizontalScope())
        {
            ...
            NitroxGUILayout.Separator();
            dimensionDrawer.Draw(rb.angularVelocity, VALUE_MAX_WIDTH);
        }
