...
public class ColorDrawer : IDrawer<Color>, IDrawer<Color32>
{
    private readonly Texture2D tex = new((int)NitroxGUILayout.VALUE_WIDTH, 25);
    ...
    public Color32 Draw(Color32 color)
    {
