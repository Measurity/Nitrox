...
public class NitroxAbstractFaker : NitroxFaker, INitroxFaker
{
    ...
    {
        // TODO: FIX THIS!
        // Assembly[] assemblies = [typeof(Packet).Assembly, typeof(SubnauticaInGameLogger).Assembly, typeof(Program).Assembly];
        // HashSet<Type> blacklistedTypes = [typeof(Packet), typeof(IPacketProcessor)];
        // List<Type> types = new();
